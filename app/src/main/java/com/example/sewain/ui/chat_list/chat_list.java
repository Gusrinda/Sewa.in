package com.example.sewain.ui.chat_list;
...
import com.example.sewain.Model.Chatlist;
...
public class chat_list extends Fragment {
    ...
    public static chat_list newInstance() {
        return new chat_list();
    }
    ...
    private void chatList() {
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                userAdapter = new AdapterUser(getContext(), mUsers, true);
